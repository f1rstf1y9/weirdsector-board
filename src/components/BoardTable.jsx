...
export default function BoardTable({
  ...
  return (
    <>
      <li
        className={`flex w-full h-[45px] sm:h-[51px] border-b border-[#E1E1E1] bg-white hover:bg-[#F9F9F9] text-sm sm:text-base cursor-pointer ${type === 'head' && 'font-bold border-t-2 border-t-black hover:bg-white cursor-default'}`}
      >
